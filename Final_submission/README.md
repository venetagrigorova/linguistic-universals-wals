...
We analyzed the following rules in this project.
| ID # | Rule |
|--------------|------------------------------|
...
### Quantitative analysis and Cross Tables

The quantitative analysis of the rules using the WALS data is found in 'crosstables.ipynb'.
...
### Corpus-based analysis with Universisal Dependencies
The corpus-based analysis of rules 20, 23, and 24 using the German UD treebank is found in milestone_3_ud_rule_20_23_24.ipynb.
